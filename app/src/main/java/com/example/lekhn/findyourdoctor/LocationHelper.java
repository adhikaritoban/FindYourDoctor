...
public class LocationHelper {
	...
	LocationListener locationListenerGps = new LocationListener() {
		...
		public void onLocationChanged(Location location) {
			...
			// if you want to stop listening to gps location updates, un-comment
			// the code below
			/*
	...
	LocationListener locationListenerNetwork = new LocationListener() {
		...
		public void onLocationChanged(Location location) {
			...
			// if you want to stop listening to network location updates,
	...
	class GetLastLocation extends TimerTask {
		...
		public void run() {
			...
			// In my case, I do not return the last known location, so I DO NOT
			// remove the updates, just return a location value of null
